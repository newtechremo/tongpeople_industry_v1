# ìµœì´ˆ ìœ„í—˜ì„±í‰ê°€ ìƒì„¸ë³´ê¸° (ì‘ì—…ê¸°ê°„ì¤‘) - êµ¬í˜„ ëª…ì„¸ì„œ

> **ì›ë³¸**: `C:\hongtong\reference\figma\ìœ„í—˜ì„±í‰ê°€ PCê´€ë¦¬ì\í˜„ì¥í†µ 2.0 PC ê´€ë¦¬ì -ìœ„í—˜ì„±í‰ê°€ ë¬¸ì„œ ìƒì„¸ë³´ê¸° ë° ìˆ˜ì‹œ ìƒì„¸ë³´ê¸°ì—ì„œ ì¶”ê°€ í™”ë©´.mp4`
> **ìƒì„±ì¼**: 2026-01-16
> **í”Œë«í¼**: PC (admin-web)
> **ë¬¸ì„œ ìœ í˜•**: êµ¬í˜„ ëª…ì„¸ì„œ (2ë‹¨ê³„)
> **ê¸°íš ë¬¸ì„œ**: `docs/ui-specs/pc/plans/2026-01-16-ìµœì´ˆìœ„í—˜ì„±í‰ê°€ìƒì„¸ë³´ê¸°-ì‘ì—…ê¸°ê°„ì¤‘-ê¸°íš.md`
...
| UI ìš”ì†Œ | ìƒíƒœ | ì»´í¬ë„ŒíŠ¸ | ê²½ë¡œ |
|---------|------|----------|------|
...
| ìƒì„¸ í—¤ë” | âš ï¸ | `AssessmentDetailHeader` | ìˆ˜ì • í•„ìš” (onEdit ì¶”ê°€) |
...
interface ApproverSearchInputProps {
  ...
  excludeIds?: string[];           // ì´ë¯¸ ì„ íƒëœ ê²°ì¬ì ì œì™¸
}
```
...
function useApproverManagement(
  ...
  const canRemove = (approver: Approver) => {
    // ì´ë¯¸ ê²°ì¬ ì™„ë£Œëœ ê²°ì¬ìëŠ” ì‚­ì œ ë¶ˆê°€
...
- [ ] InitialAssessmentDetailPage (ìƒíƒœë³„ ë¶„ê¸°)
...
- ê¸°íš ë¬¸ì„œ: `docs/ui-specs/pc/plans/2026-01-16-ìµœì´ˆìœ„í—˜ì„±í‰ê°€ìƒì„¸ë³´ê¸°-ì‘ì—…ê¸°ê°„ì¤‘-ê¸°íš.md`
- ì‘ì—…ì¢…ë£Œ êµ¬í˜„: `docs/ui-specs/pc/specs/2026-01-16-ìµœì´ˆìœ„í—˜ì„±í‰ê°€ìƒì„¸ë³´ê¸°-ì‘ì—…ì¢…ë£Œ-êµ¬í˜„.md`

---

## 9. ÀÛ¾÷±â°£ »óÅÂº° ¼öÁ¤ ±ÔÄ¢

| »óÅÂ | ¼³¸í | ÀÛ¾÷±â°£ ¼öÁ¤ | »ó¼¼ ³»¿ë ¼öÁ¤ |
|------|------|---------------|----------------|
| ÀÛ¾÷±â°£ Àü | ÀÛ¾÷ ½ÃÀÛ Àü | ½ÃÀÛ/Á¾·á ¸ğµÎ ¼öÁ¤ °¡´É | ¼öÁ¤ °¡´É |
| ÀÛ¾÷±â°£ Áß | ÀÛ¾÷ ÁøÇà Áß | ½ÃÀÛÀÏ ¼öÁ¤ ºÒ°¡, Á¾·áÀÏ ¼öÁ¤ °¡´É | ¼öÁ¤ °¡´É |
| ÀÛ¾÷Á¾·á | ÀÛ¾÷ Á¾·á | ¼öÁ¤ ºÒ°¡ | ¼öÁ¤ ºÒ°¡ |

**È­¸é Ã³¸®:**
- ÀÛ¾÷±â°£ Àü/Áß -> °áÀç¶óÀÎ ¼öÁ¤ °¡´É
- ÀÛ¾÷Á¾·á -> °áÀç¶óÀÎ ÀĞ±â Àü¿ë + Ãâ·Â/»èÁ¦/ÀçÀÛ¼º ¹öÆ° Ç¥½Ã

---

## Á¤Á¤: °áÀç¶óÀÎ/¼­¸í µ¿ÀÛ

- °áÀç¶óÀÎÀº **Á÷Á¢ ÆíÁıÇÏ´Â °ÍÀÌ ¾Æ´Ï¶ó ±âÁ¸ °áÀç¶óÀÎÀ» ¼±ÅÃ**ÇÏ´Â ¹æ½ÄÀÌ´Ù.
- ÀÛ¾÷±â°£ Àü/Áß¿¡¼­ **´Ù¸¥ °áÀç¶óÀÎ ¼±ÅÃ °¡´É**ÇÏ¸ç, ¼±ÅÃ ½Ã °áÀçÀÚ ¸ñ·ÏÀÌ ±³Ã¼µÈ´Ù.
- °áÀç¶óÀÎ¿¡´Â **°áÀçÀÚº° ÀüÀÚ¼­¸í ¿µ¿ª**ÀÌ ÇÊ¿äÇÏ´Ù.
- ÀüÀÚ¼­¸íÀº ÃÖÃÊ 1È¸ ÀúÀåµÈ ¼­¸íÀ» Å¬¸¯ÇØ Àû¿ëÇÑ´Ù.
- °áÀç¶óÀÎ º¯°æ ½Ã ±âÁ¸ ¼­¸í µ¥ÀÌÅÍ´Â **¸ğµÎ ÃÊ±âÈ­**µÈ´Ù.
- °áÀç¶óÀÎ º¯°æ Àü °æ°í ¸Ş½ÃÁö ÇÊ¼ö: "±âÁ¸ ¼­¸í Á¤º¸´Â ÀúÀåµÇÁö ¾ÊÀ¸¸ç »èÁ¦µË´Ï´Ù. °è¼ÓÇÏ½Ã°Ú½À´Ï±î?"

...
-- 3. 협력업체(팀) 데이터
-- site_id: 소속 현장 (NULL이면 회사 전체에 속한 팀)
INSERT INTO partners (id, company_id, site_id, name, contact_name, contact_phone)
VALUES
    (1, 1, 1, '(주)정이앤지', '정철수', '010-1234-5678'),       -- 경희대 현장
    (2, 1, 1, '한국건설(주)', '김영희', '010-2345-6789'),       -- 경희대 현장
    (3, 1, 2, '대한전기', '박민수', '010-3456-7890'),           -- 삼성전자 현장
    (4, 1, 2, '(주)삼우설비', '이지훈', '010-4567-8901'),       -- 삼성전자 현장
    (5, 1, 3, '현대건설직영', '최현우', '010-5678-9012'),       -- 현대건설 본사
    (6, 1, NULL, '본사관리팀', '관리자', '02-1234-5678');       -- 회사 전체 팀

SELECT setval('partners_id_seq', 6);
